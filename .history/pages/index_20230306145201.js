  ...
  return (
    <>
      ...
      <FlexBox className='mainCont' dir="column" linearGradient="linear-gradient(180deg, #717ADD 0%, rgba(113, 122, 221, 0.13) 100%)" zIndex="-100">
        ...
        <motion.div initial={{position:'absolute', y: -1100, x: -1500}} animate={{y: -1100, x:1400}} transition={{duration:'50', ease:'linear', delay:1}}>
          <Image src='/cloudy.svg' width="400px" zIndex='-200'></Image>
        </motion.div>
