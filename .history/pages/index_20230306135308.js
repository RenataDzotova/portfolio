  ...
  return (
    <>
      ...
      <FlexBox className='mainCont' dir="column" linearGradient="linear-gradient(180deg, #717ADD 0%, rgba(113, 122, 221, 0.13) 100%)" zIndex="-100">
        ...
        <motion.div initial={{position:'absolute', top:'0', left:"20vw"}} animate={{rotate: [-20, 20, -20]}} transition={{duration:'4', repeat: Infinity}}><Image src='/guys.svg' width="120px" position="absolute" top="-20vh" left="20%" opacity='50%' zIndex='-100'></Image></motion.div>
