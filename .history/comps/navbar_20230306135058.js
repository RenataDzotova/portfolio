...
export default function NavBar({
    ...
    return(
        <FlexBox fontFamily="PT Sans Narrow" position="fixed" alignItems="end" bgColor="rgba(113, 122, 221, 0.4);" top="0" width="100vw" height="60px" justifyContent="space-between" padding="10px 25px 10px 50px" zIndex="2">
